...
[Click here to download the `setup.sh` file](https://cdn.rawgit.com/develop-me/setup/9a561ee268c159ed16f77168920032ff41c77f0c/linux/setup.sh) and save it to your Downloads directory (e.g. `~/Downloads`). Next, in Terminal, run the following:
