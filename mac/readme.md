...
[Click here to Download the `setup.sh` file](https://rawgit.com/develop-me/setup/master/mac/setup.sh) and save it to your Downloads directory (e.g. `/Users/yourname/Downloads`). Next open the Terminal app and run the following:
